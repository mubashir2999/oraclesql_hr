...
department_name varchar2(30) constraint department_name_NN NOT NULL,
...
location_id number(4) constraint LOCATION_ID_PK PRIMARY KEY,
...
constraint employees_jobs_fk FOREIGN KEY(job_id) references jobs(job_id));
-------------------------------------------------------------------------------------------------------------------------------------
alter table employees add department_id number(4)
--------------------------------------------------------------------------------------------------------------------------------------
alter table employees add(
constraint employees_departments_fk FOREIGN KEY(department_id) references departments(department_id));
--------------------------------------------------------------------------------------------------------------------------------------------
...
start_date date constraint start_date_pk primary key,
end_date date,
job_id varchar2(10),
department_id number(4));

alter table job_history add(
constraint job_history_employees_fk FOREIGN KEY(employee_id) REFERENCES employees(employee_id),
constraint job_history_jobs_fk FOREIGN KEY(job_id) REFERENCES jobs(job_id),
constraint job_history_departments_fk FOREIGN KEY(department_id) REFERENCES departments(department_id));
-------------------------------------------------------------------------------------------------------------------------------------------
...
region_id number(4) constraint region_id_pk primary key,
region_name varchar2(25) constraint region_name_nn not null);
--------------------------------------------------------------------------------------------------------------------------------------------------
create table managers(
manager_id number(6) constraint manager_id_pk PRIMARY key,
employee_id number(6));
-------------------------------------------------------------------------------------------------------------------------------------------------------
alter table managers add(
constraint employees_managers_fk foreign key(employee_id) REFERENCES employees(employee_id));
--------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------
alter table countries add region_id number(4);
alter table countries modify(country_id varchar2(5));
...
describe employees
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
alter table employees add constraint employees_manager_fk foreign key(manager_id) references managers(manager_id);

alter table managers disable constraint employees_manager_fk

ALTER TABLE employees
DISABLE CONSTRAINT employees_manager_fk;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
drop table managers
alter table managers disable constraint manager_id_pk;
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
